  ...
  return (
    ...
    >
          ...
          <button
            ...
            className={`p-4 rounded-lg border-2 transition-all ${
              selectedMethod === method.value
                ...
                : 'border-[var(--border)] hover:border-accent/50 bg-[var(--background-secondary)]'
            }`}
          >
        ...
        <div className="space-y-4 border-t border-[var(--border)] pt-6">
          ...
          <div className="flex items-center">
            <input
              ...
              className="h-4 w-4 text-accent rounded border-[var(--border)] focus:ring-accent focus:ring-offset-0"
            />
            <label 
              htmlFor="saveCard" 
              className="ml-2 text-sm text-[var(--foreground-secondary)]"
            >
      ...
      <div className="mt-6 pt-6 border-t border-[var(--border)]">
        <div className="flex items-center justify-center gap-2 text-sm text-[var(--foreground-tertiary)]">
