    ...
    >
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          {items.map((item) => (
            <div key={item.id} className="flex items-center gap-4 p-4 border border-border rounded-lg bg-bg-secondary">
              <div className="w-16 h-16 rounded-lg overflow-hidden bg-bg-tertiary">
                <img
                  src={item.image}
                  alt={item.name}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div>
          ...
          <div className="bg-bg-tertiary rounded-lg p-4 border border-border">
            ...
            <p className="text-text-secondary">{formData.shipping?.address?.street}</p>
            <p className="text-text-secondary">
              {formData.shipping?.address?.city}, {formData.shipping?.address?.state} {formData.shipping?.address?.zipCode}
            </p>
            <p className="text-text-secondary">{formData.shipping?.address?.country}</p>
            <p className="text-text-secondary mt-2">{formData.personalInfo?.phone}</p>
            <p className="text-text-secondary">{formData.personalInfo?.email}</p>
      ...
      {!useShippingAsBilling && formData.billing && (
        <div className="mb-8">
          ...
          <div className="bg-(--background-tertiary) rounded-lg p-4 border border-border">
            ...
            <p className="text-text-secondary">{formData.billing.country}</p>
          </div>
        </div>
      )}
